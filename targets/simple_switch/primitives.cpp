...
class generate_digest : public ActionPrimitive<const Data &, const Data &> {
  void operator ()(const Data &receiver, const Data &learn_id) {
    ...
    int receiver_id = receiver.get_int();
    switch (receiver_id) {
      case 0 :
        get_field("intrinsic_metadata.degist_receiver0").set(learn_id);
        break;
      case 1 :
        get_field("intrinsic_metadata.degist_receiver1").set(learn_id);
        break;
      case 2 :
        get_field("intrinsic_metadata.degist_receiver2").set(learn_id);
        break;
      case 3 :
        get_field("intrinsic_metadata.degist_receiver3").set(learn_id);
        break;
      case 4 :
        get_field("intrinsic_metadata.degist_receiver4").set(learn_id);
        break;
      case 5 :
        get_field("intrinsic_metadata.degist_receiver5").set(learn_id);
        break;
      case 6 :
        get_field("intrinsic_metadata.degist_receiver6").set(learn_id);
        break;
      case 7 :
        get_field("intrinsic_metadata.degist_receiver7").set(learn_id);
        break;
      case 8 :
        get_field("intrinsic_metadata.degist_receiver8").set(learn_id);
        break;
      case 9 :
        get_field("intrinsic_metadata.degist_receiver9").set(learn_id);
        break;
    }
  }
};
